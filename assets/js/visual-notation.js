(function () {
  ...
  var nodeMessages = {
    'svg-text-annotation': {
      ...
      content: 'Text annotations consist of a square bracket followed by an explanatory text or a comment.'
    },
    'svg-business-knowledge-model': {
      title: 'Business Knowledge Model (BKM)',
      content: '<p>BKMs encapsulate business knowledge as reusable functions.</p><p>The decision logic can hold a FEEL function, a Java method invocation, or a PMML invocation.</p>'
    },
    'svg-input-data': {
      title: 'Input data',
      content: '<p>Input data elements denote information used as input for one or more decisions.</p><p>When enclosed within a Business Knowledge Model (BKM), they indicate parameters for the BKM node.</p>'
    },
    'svg-decision-service': {
      title: 'Decision Service',
      content: '<p>Decision services may enclose a set of reusable decisions (not shown in the element to the right).</p><p>They can be invoked internally by another decision, or externally by a BPMN process or another DMN model.</p>'
    },
    'svg-knowledge-source': {
      title: 'Knowledge source',
      content: 'A knowledge source denotes an authority for a BKM or a decision node.'
    },
    'svg-decision': {
      title: 'Decision',
      content: '<p>Decisions determine an output value depending on:</p><ul><li>their <b>input data</b> (input nodes or the output value from other decisions)</li><li>their <b>decision logic</b> - boxed expressions that may reference functions from BKM nodes</li></ul>'
    }
  };
  ...
  function drop(ev) {
    ...
    function getSuffix() {
      if (isFinished) {
        ...
        return '<b><p>You\'ve dragged ' + numberOfDraggedElements + ' of ' + numberOfPalleteItems + '!</p></b><p>Keep dragging :-)</p>';
      }
    }
  ...
  function showTryItNowMessage() {
    ...
    var content = '<p>The main <b>DRD (Decision Requirements Diagrams) components</b> live in the editor palette.</p>' +
